...
public:
  ...
  void drawPatches(NS::UInteger numberOfPatchControlPoints,
                   ...
                   const class Buffer *buffer, NS::UInteger offset,
...
public:
  ...
  void setKernelBuffer(const class Buffer *buffer, NS::UInteger offset,
                       NS::UInteger index);
  ...
  void concurrentDispatchThreads(MTL::Size threadsPerGrid,
                                 MTL::Size threadsPerThreadgroup);
...
_MTL_INLINE void MTL::IndirectRenderCommand::setVertexBuffer(
...
_MTL_INLINE void MTL::IndirectRenderCommand::setFragmentBuffer(
    const MTL::Buffer *buffer, NS::UInteger offset, NS::UInteger index) {
  Object::sendMessage<void>(this,
...
_MTL_INLINE void MTL::IndirectRenderCommand::drawPatches(
  ...
  Object::sendMessage<void>(
      ...
      patchIndexBufferOffset, instanceCount, baseInstance, buffer, offset,
      instanceStride);
}
...
_MTL_INLINE void MTL::IndirectRenderCommand::drawIndexedPatches(
  ...
  Object::sendMessage<void>(
      ...
      controlPointIndexBufferOffset, instanceCount, baseInstance, buffer,
      offset, instanceStride);
}

// method: drawPrimitives:vertexStart:vertexCount:instanceCount:baseInstance:
_MTL_INLINE void MTL::IndirectRenderCommand::drawPrimitives(
...
_MTL_INLINE void MTL::IndirectRenderCommand::setObjectThreadgroupMemoryLength(
...
_MTL_INLINE void MTL::IndirectRenderCommand::setObjectBuffer(
    const MTL::Buffer *buffer, NS::UInteger offset, NS::UInteger index) {
  Object::sendMessage<void>(this,
...
_MTL_INLINE void MTL::IndirectRenderCommand::setMeshBuffer(
    const MTL::Buffer *buffer, NS::UInteger offset, NS::UInteger index) {
  Object::sendMessage<void>(this,
...
_MTL_INLINE void MTL::IndirectRenderCommand::drawMeshThreads(
...
_MTL_INLINE void MTL::IndirectComputeCommand::setKernelBuffer(
    const MTL::Buffer *buffer, NS::UInteger offset, NS::UInteger index) {
  Object::sendMessage<void>(this,
                            _MTL_PRIVATE_SEL(setKernelBuffer_offset_atIndex_),
                            buffer, offset, index);
}
...
_MTL_INLINE void MTL::IndirectComputeCommand::setKernelBuffer(
    ...
    NS::UInteger index) {
  Object::sendMessage<void>(
      this, _MTL_PRIVATE_SEL(setKernelBuffer_offset_attributeStride_atIndex_),
      buffer, offset, stride, index);
}
...
_MTL_INLINE void MTL::IndirectComputeCommand::concurrentDispatchThreads(
  ...
  Object::sendMessage<void>(
      this, _MTL_PRIVATE_SEL(concurrentDispatchThreads_threadsPerThreadgroup_),
...
_MTL_INLINE void
MTL::IndirectComputeCommand::setImageblockWidth(NS::UInteger width,
                                                NS::UInteger height) {
...
_MTL_INLINE void
MTL::IndirectComputeCommand::setThreadgroupMemoryLength(NS::UInteger length,
                                                        NS::UInteger index) {
  Object::sendMessage<void>(
...
_MTL_INLINE void
MTL::IndirectComputeCommand::setStageInRegion(MTL::Region region) {
