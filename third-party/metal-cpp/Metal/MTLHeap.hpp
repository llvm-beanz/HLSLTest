...
_MTL_INLINE MTL::HeapDescriptor *MTL::HeapDescriptor::alloc() {
  return NS::Object::alloc<MTL::HeapDescriptor>(
      _MTL_PRIVATE_CLS(MTLHeapDescriptor));
}
...
_MTL_INLINE void
MTL::HeapDescriptor::setStorageMode(MTL::StorageMode storageMode) {
...
_MTL_INLINE void
MTL::HeapDescriptor::setCpuCacheMode(MTL::CPUCacheMode cpuCacheMode) {
...
_MTL_INLINE MTL::SparsePageSize MTL::HeapDescriptor::sparsePageSize() const {
  return Object::sendMessage<MTL::SparsePageSize>(
      this, _MTL_PRIVATE_SEL(sparsePageSize));
}

_MTL_INLINE void
MTL::HeapDescriptor::setSparsePageSize(MTL::SparsePageSize sparsePageSize) {
  Object::sendMessage<void>(this, _MTL_PRIVATE_SEL(setSparsePageSize_),
                            sparsePageSize);
}

// property: hazardTrackingMode
_MTL_INLINE MTL::HazardTrackingMode
MTL::HeapDescriptor::hazardTrackingMode() const {
...
_MTL_INLINE void
MTL::HeapDescriptor::setResourceOptions(MTL::ResourceOptions resourceOptions) {
...
_MTL_INLINE NS::UInteger MTL::Heap::maxAvailableSize(NS::UInteger alignment) {
  return Object::sendMessage<NS::UInteger>(
      this, _MTL_PRIVATE_SEL(maxAvailableSizeWithAlignment_), alignment);
}

// method: newBufferWithLength:options:
_MTL_INLINE MTL::Buffer *MTL::Heap::newBuffer(NS::UInteger length,
...
MTL::Heap::newTexture(const MTL::TextureDescriptor *descriptor) {
  return Object::sendMessage<MTL::Texture *>(
      this, _MTL_PRIVATE_SEL(newTextureWithDescriptor_), descriptor);
}

// method: setPurgeableState:
_MTL_INLINE MTL::PurgeableState
MTL::Heap::setPurgeableState(MTL::PurgeableState state) {
...
_MTL_INLINE MTL::Buffer *MTL::Heap::newBuffer(NS::UInteger length,
                                              ...
                                              NS::UInteger offset) {
  return Object::sendMessage<MTL::Buffer *>(
      this, _MTL_PRIVATE_SEL(newBufferWithLength_options_offset_), length,
      options, offset);
}
...
MTL::Heap::newTexture(const MTL::TextureDescriptor *descriptor,
                      NS::UInteger offset) {
  return Object::sendMessage<MTL::Texture *>(
      this, _MTL_PRIVATE_SEL(newTextureWithDescriptor_offset_), descriptor,
      offset);
}

// method: newAccelerationStructureWithSize:
_MTL_INLINE MTL::AccelerationStructure *
MTL::Heap::newAccelerationStructure(NS::UInteger size) {
...
_MTL_INLINE MTL::AccelerationStructure *
MTL::Heap::newAccelerationStructure(NS::UInteger size, NS::UInteger offset) {
  return Object::sendMessage<MTL::AccelerationStructure *>(
      this, _MTL_PRIVATE_SEL(newAccelerationStructureWithSize_offset_), size,
      offset);
}
...
_MTL_INLINE MTL::AccelerationStructure *MTL::Heap::newAccelerationStructure(
    ...
    NS::UInteger offset) {
  return Object::sendMessage<MTL::AccelerationStructure *>(
      this, _MTL_PRIVATE_SEL(newAccelerationStructureWithDescriptor_offset_),
      descriptor, offset);
}
